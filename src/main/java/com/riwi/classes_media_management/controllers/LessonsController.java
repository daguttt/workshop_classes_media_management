...
public class LessonsController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "201", description = "Lesson successfully created",
                    content = { @Content(mediaType = "application/json",
                            schema = @Schema(implementation = LessonReponseDTO.class)) }),
            @ApiResponse(responseCode = "400", description = "Invalid file format",
                    content = { @Content(mediaType = "application/json") }),
            @ApiResponse(responseCode = "404", description = "`classId` not found",
                    content = { @Content(mediaType = "application/json") }), })
    @RequestBody(description = "Schema to create a Lesson.\n"
            ...
            + "- When *'AUDIO'* or *'VIDEO'* `mediaType` is selected, the `file` field is **required** and the `content` field should be empty.",
            content = {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Lesson successfully disabled",
                    content = { @Content(mediaType = "application/json",
                            schema = @Schema(implementation = LessonDisabledDTO.class)) }),
            @ApiResponse(responseCode = "404", description = "Lesson's `id` not found",
                    content = { @Content(mediaType = "application/json") }), })
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Lesson successfully fetched",
                    content = { @Content(mediaType = "application/json",
                            schema = @Schema(implementation = LessonReponseDTO.class)) }),
            @ApiResponse(responseCode = "404", description = "Lesson's `id` not found",
                    content = { @Content(mediaType = "application/json") }), })
